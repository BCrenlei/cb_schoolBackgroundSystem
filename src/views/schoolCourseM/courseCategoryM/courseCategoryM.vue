<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" :element-loading-text="$t('msg.loading')" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column width="220px" align="center" :label="$t('list.courseSortName')" :prop="renderlanguage(l_params.typeName)">
      </el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form :rules="rules" ref="temp" :model="temp" label-position="right" label-width="130px" style='width: 500px; margin-left:50px;'>
        ...
        <el-form-item :label="$t('new.typeName')" prop="typeName">
          <el-input v-model="temp.typeName"></el-input>
        </el-form-item>

        <el-form-item :label="$t('new.typeNameEn')" prop="typeNameEn">
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      listNewCategory(p).then(response => {
        this.list = response
